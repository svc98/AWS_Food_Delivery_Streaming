...
jdbc_jar_s3_path = "s3://food-delivery-stream/jars/redshift-connector-jar/redshift-jdbc42-2.1.0.12.jar"
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://food-delivery-stream-bucket/pyspark_script/pyspark_streaming.py',
